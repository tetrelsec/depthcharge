...
class ReverseCRC32Hunter(Hunter):
    ...
    **Implementation Details**
    ...
    <https://github.com/tetrelsec/depthcharge/blob/main/python/depthcharge/revcrc32.py>`_.
    ...
    **Example**
    ...
    <https://github.com/tetrelsec/depthcharge/blob/main/python/examples/reverse_crc32_algo_poc.py>`_
